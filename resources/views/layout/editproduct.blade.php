...
@section("content")
    ...
    <div class="page-header" style="background-image: url(img/products/{{ $data['product'][0]['image_source'] }});">
    </div>
    ...
    @csrf
    <input type="number" name="id" id="id" value="{{ $data['product'][0]['product_id'] }}" hidden>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row mb-5 px-3">
                                    <div class="col-4">
                                        <img class="border" width="200" src="{{ url('/') }}/img/products/{{ $data['product'][0]['image_source'] }}">
                                    </div>
                                    <div class="col">
                                        <div class="row my-1">
                                            <div class="col"><img class="border" width="100" height="100" src="{{ url('/') }}/img/products/{{ $data['product'][0]['image_source'] }}"></div>
                                            <div class="col"><img class="border" width="100" height="100" src="{{ url('/') }}/img/products/{{ $data['product'][0]['image_source'] }}"></div>
                                            <div class="col"><img class="border" width="100" height="100" src="{{ url('/') }}/img/products/{{ $data['product'][0]['image_source'] }}"></div>
                                        </div>
                                        <div class="row my-1">
                            ...
                            <div class="card-body border-top">
                                ...
                                <div class="w-25">
                                    ...
                                    <div class="input-group mb-3 mx-1">
                                        ...
                                        <input type="number" class="form-control" id="p-priceinput" name="p_price" placeholder="Price" aria-label="Price" aria-describedby="price-icon" value="{{ $data['product'][0]['product_price'] }}">
                                    </div>
                                </div>
                                ...
                                <div class="row w-50 mb-3" id="discount-form" style="display: none">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3 mx-1">
                                            ...
                                            <input type="number" class="form-control" id="p-priceinput" name="p_sale_price" placeholder="Price" aria-label="Price" aria-describedby="price-icon" value="{{ $data['product'][0]['product_sale_price'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="custom-control custom-switch mx-1 mb-3">
